...
public class ExpiredAccessTokenException extends RuntimeException {
    @Serial
    private static final long serialVersionUID = 8102108149422097050L;
     ...
     */
    public ExpiredAccessTokenException(String message, ServerRequest serverRequest) {
        super(message);
     ...
     * @since 1.4
     */
    public ExpiredAccessTokenException(String message, Throwable cause, ServerRequest serverRequest) {
        super(message, cause);
        this.serverRequest = serverRequest;
    }
