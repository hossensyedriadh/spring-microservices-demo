...
public class MalformedTokenException extends RuntimeException {
    @Serial
    private static final long serialVersionUID = -8131868143880016479L;
     ...
     */
    public MalformedTokenException(String message, ServerRequest serverRequest) {
        super(message);
     ...
     * @since 1.4
     */
    public MalformedTokenException(String message, Throwable cause, ServerRequest serverRequest) {
        super(message, cause);
        this.serverRequest = serverRequest;
    }
